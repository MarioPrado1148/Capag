...
st.title("<h1 style='text-align: justified; color: black;'>'Classificação da capacidade de pagamento dos municípios brasileiros com base em dados geoeconômicos'</h1>", unsafe_allow_html=True)
	...
	if select_event_cientista == 'Coleta de Dados':
		...
		if select_radio_cientista == 'Região Metropolitana':
			...
			with col2: 
			    ...
			    st.markdown("<h1 style='text-align: center; color: red;'>Gostou deste gráfico, Cruz?</h1>", unsafe_allow_html=True)
