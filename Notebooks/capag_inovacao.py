...
#st.title("<h1 style='text-align: justify; color: black;'>'Classificação da capacidade de pagamento dos municípios brasileiros com base em dados geoeconômicos'</h1>", unsafe_allow_html=True)
...
if radio == 'Visão cidadão':
	...
	if select_event_cidadao == 'Apresentação':
		...
		st.markdown('Mario José Calvão Monnerat do Prado é pai da Nicole, auditor-fiscal da Receita Federal, formado em Data Mining pela FIA/USP, formado no MBA em Analytics e Inteligência Artificial da Fundação FIA/USP, estudante na pós-graduação em Direito Tributário e Compliance pela Universidade Católica de Brasília. Atualmente é supervisor do Laboratório de Inovação da SRRF08 da Receita Federal do Brasil')
