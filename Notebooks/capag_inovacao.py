...
if radio == 'Visão cidadão':
	...
	if select_event_cidadao == 'Apresentação':
		...
		st.markdown('A CAPAG pode ter os valores A, B, C e D, sendo que as notas A e B indica que o município possui capacidade de pagamento e C e D indicam o contrário')
...
if radio == 'Visão cientista de dados':
	...
	if select_event_cientista == 'Coleta de Dados':
		...
		st.markdown('1 - Capacidade de Pagamento (CAPAG) dos Municípios')
	     #   st.markdown('Arquivo disponível no formato csv, posteriormente convertido em excel. O dataset possui 5569 linhas e 11 colunas.')
		#st.markdwon('Os dados foram coletados no website da Transparência do Tesouro Nacional 1, em janeiro de 2021. Link: http://www.tesourotransparente.gov.br/ckan/dataset/capag-municipios')
