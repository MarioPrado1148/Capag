...
if radio == 'Visão cidadão':
	...
	if select_event_cidadao == 'Apresentação':
		...
		texto1 = 'tataNeste trabalho, utilizamos um modelo de aprendizado de máquina denominado Gradient Boosting com o objetivo de, utilizando as informações disponíveis \
