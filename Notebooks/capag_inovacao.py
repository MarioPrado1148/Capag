...
#st.title("<h1 'text-align: justify; color: black;'>'Classificação da capacidade de pagamento dos municípios brasileiros com base em dados geoeconômicos'</h1>", unsafe_allow_html=True)
