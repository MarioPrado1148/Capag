...
#st.title("<h1 style={'text-align: justify,"background-color:powderblue}; color: black;'>'Classificação da capacidade de pagamento dos municípios brasileiros com base em dados geoeconômicos'</h1>", unsafe_allow_html=True)
