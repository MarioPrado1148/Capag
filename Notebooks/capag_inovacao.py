...
if radio == 'Visão cidadão':
	...
	if select_event_cidadao == 'Apresentação':
		...
		st.markdown('Mario José Calvão Monnerat do Prado é pai, auditor-fiscal da Receita Federal, formado em Data Mining pela FIA/USP, formado no MBA em Analytics e Inteligência Artificial da Fundação FIA/USP, estudante na pós-graduação em Direito Tributário e Compliance pela Universidade Católica de Brasília. Atualmente é supervisor do Laboratório de Inovação da SRRF08 da Receita Federal do Brasil')
